...
class Condition extends Component{
 ...
 <div id="demo" className="carousel" data-bs-ride="carousel" data-aos="fade-up-right">
  ...
  <div className="carousel-inner">
    ...
    <video src="Skin Care.mp4" className="d-block" type="video/mp4"  loop muted alt="Chicago" autoPlay={true}   style={{width:'100%',height:'488px',margin:'8px'}}></video>
    </div>
         ...
         <div className="section m-4" style={{backgroundColor: '#faebd77d',alignItems:'baseline'}}>
            ...
            <img src="https://i.ibb.co/SQWGnf6/100-natural-Products.png" alt="1" style={{height:'350px'}}/>
               ...
               "Experience the power of nature with our 100% natural cosmetic line, designed to nourish and protect your skin with the best that nature has to offer."

"At our company, we believe that natural is always better, which is why we've created a 100% natural cosmetic line that harnesses the healing properties of botanicals and other natural ingredients for optimal skin health."
               </p>
               </div>
            </div>
         ...
         <div className="section" style={{backgroundColor: '#98a3a47a',alignItems:'center'}}>
            <div className="text" data-aos="fade-left">
               ...
               "Unlike mass-produced cosmetics, our handmade beauty products are made in small batches to ensure the highest quality and freshness, giving you a luxurious experience that you won't find anywhere else."
...
"We believe that beauty and veganism can go hand in hand, which is why we've created a 100% vegan cosmetic line that is both luxurious and ethical."

"With our 100% vegan cosmetic products, you will experience the power of plant-based ingredients without harming animals or the environment."
               </p>
               </div>
...
"Discover the transformative power of nature with our organic cosmetic products, suitable for all skin types and free of harsh chemicals or synthetic fragrances."

"With our line of products, you can experience the benefits of organic skincare with the finest ingredients for a healthy, radiant complexion, no matter your skin type."

"Our cosmetic line is designed for all skin types and made with the highest standards of purity and sustainability, so say goodbye to skin irritations and hello to pure, organic ingredients."
...
<div style={{backgroundImage:"url('/back1.png')",backgroundSize:'cover'}} data-aos="fade-up-right">
            <div >
                ...
                <p style={{fontFamily:'auto',fontStyle:'oblique',color:'green',fontSize:'22px'}}>The products we offer are designed to cater to all your beauty needs, including creams, serums, oils, and other skincare essentials. We have a moisturizing cream for dry skin, a nourishing serum for damaged hair, or a refreshing body oil for a spa-like feeling.</p>
                <p style={{fontFamily:'auto',fontStyle:'oblique',color:'green',fontSize:'22px'}}>Pure essential oils, plant-based extracts, and botanicals are some of the highest quality natural ingredients that we use to ensure that every product we create is gentle, non-toxic, and effective. The quality and safety of our products are never compromised because our ingredients are carefully sourced from trusted suppliers.</p>
                <p style={{fontFamily:'auto',fontStyle:'oblique',color:'green',fontSize:'22px'}}>At <span style={{fontWeight: 'bold',fontFamily: 'poppins'}}>aj wellness</span>, we believe in creating products that are not only good for you, but also for the environment as well. We use eco-friendly packaging and try to reduce waste in all our processes. We take great pride in promoting sustainability and doing our part to protect the planet.</p>
                <p style={{fontFamily:'auto',fontStyle:'oblique',color:'green',fontSize:'22px'}}>Products that promote wellness and enhance your natural beauty are what we are passionate about creating. Our goal is to give you a luxurious and indulgent skincare experience that you can feel good about. Take a look at our products today and experience the difference that natural, handcrafted skincare can make in your life.</p>
            </div>
            </div>
            </div>
