      ...
      <div className="carousel-inner" >
        <div className="carousel-item active" style={{objectFit:'cover'}}>
         ...
         <div className="carousel-caption" data-aos="fade-up">
           <h3 style={{color:'black'}}><img src="logo.png" alt="logo" style={{width: '25%',position: 'sticky',alignItems: 'center'}} data-aos="fade"/></h3>
           {/* <h2 style={{fontSize: '30px',fontFamily:'Lobster cursive',marginTop:'-47px',padding: '29px', color: 'black'}}></h2> */}
    <p style={{color:'black' ,fontSize: '22px',fontFamily:'Lobster cursive' }} data-aos="fade-left">We at<span> aj wellness</span> pamper you with most happening beauty treatments & customised personal care products, with a byte of holisticity !!!</p>
      <p style={{color:'black' ,fontSize: '22px',fontFamily: 'Playfair Display serif'}} data-aos="fade-right">  Get in touch with us, for your personalised beauty regimen;</p>
        ...
        <div className="carousel-item " style={{objectFit:'cover'}}>
         ...
         <div className="carousel-caption">
           <h3 style={{color:'black' ,fontFamily:'Lobster cursive'}} data-aos="fade-right">Handcrafted, lab produce; formulated to meet everyday's beauty wants. Affordability & minimalism at its core, "essentials only" is our brand philosophy.</h3>
           <p style={{color:'black' ,fontFamily:' poppins',fontSize:'20px'}} data-aos="fade-left">We all have individual cosmetic needs & one product or formulation doesn't fit all skin types, so why we are very</p>
           <p style={{color:'black' ,fontFamily:'poppins',fontSize:'20px'}} data-aos="fade-up">enthusiastic to offer our customized services - literally at minimal to no extra costs. Get in touch with us to know more.</p>
        ...
        <div className="carousel-item">
          ...
          <div className="carousel-caption">
            <h3 style={{color:'black' ,fontFamily:'Lobster cursive'}} data-aos="fade-right">Meanwhile, you can also try our standard products </h3>
            <h3 style={{color:'black' ,fontFamily:'Lobster cursive'}} data-aos="fade-up"> & share your experiences !!!</h3>
            <p style={{color:'black' ,fontFamily:'Lobster cursive'}} data-aos="fade-left">Thank you</p>
          </div>
        </div>
